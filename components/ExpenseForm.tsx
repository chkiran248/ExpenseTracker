...
const ExpenseForm: React.FC<ExpenseFormProps> = ({ onClose, onSubmit, initialData }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#162a0a]/60 backdrop-blur-xl">
      <div className="bg-white w-full max-w-lg rounded-[2rem] shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-300 border border-[#8cc045]/20">
        <div className="p-8 border-b border-stone-50 flex justify-between items-center bg-[#8cc045]/5">
          <div>
